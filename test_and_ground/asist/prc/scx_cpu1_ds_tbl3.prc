...
;; Entry 1
SCX_CPU1_DS_DF_TBL_Description  = "Filter Test"
...
s create_tbl_file_from_cvt(hostCPU,fileAppid,"File Write Test File Table","ds_filtfile.tbl",fileTblName,"SCX_CPU1_DS_DF_TBL_Description",endmnemonic)

;; Setup the Packet Filter Table
SCX_CPU1_DS_PF_TBL_Description  = "Filter Test"
;; Entry 1
...
s create_tbl_file_from_cvt(hostCPU,filterAppid,"Filter Test Filter Table","ds_filtfilter.tbl",filterTblName,"SCX_CPU1_DS_PF_TBL_Description",endmnemonic)

%liv (log_procedure) = logging

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_ds_tbl3"
write ";*********************************************************************"
ENDPROC
