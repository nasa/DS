...
;; Entry 1
SCX_CPU1_DS_DF_TBL_Description  = "General Commands Test"
SCX_CPU1_DS_DF_TBL[0].Pathname  = "/ram/"
SCX_CPU1_DS_DF_TBL[0].Basename  = "ds_hk"
...
s create_tbl_file_from_cvt(hostCPU,fileAppid,"General Command Test File Table","ds_gcfile.tbl",fileTblName,"SCX_CPU1_DS_DF_TBL_Description",endmnemonic)

;; Setup the Packet Filter Table
SCX_CPU1_DS_PF_TBL_Description  = "General Commands Test"
;; Entry 1
SCX_CPU1_DS_PF_TBL[0].MessageID = filter1MID
...
;; Entry 2
SCX_CPU1_DS_PF_TBL[1].MessageID = filter2MID
...
SCX_CPU1_DS_PF_TBL[1].FilterParams[0].X_Value = 2
SCX_CPU1_DS_PF_TBL[1].FilterParams[0].O_Value = 1
for j = 1 to DS_FILTERS_PER_PACKET-1 do
...
s create_tbl_file_from_cvt(hostCPU,filterAppid,"General Command Test Filter Table","ds_gcfilter.tbl",filterTblName,"SCX_CPU1_DS_PF_TBL_Description",endmnemonic)

%liv (log_procedure) = logging

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_ds_tbl1"
write ";*********************************************************************"
ENDPROC
