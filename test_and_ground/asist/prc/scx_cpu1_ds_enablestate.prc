...
if (DS_CDS_ENABLE_STATE = 1) then
  ...
  if (DS_DEF_ENABLE_STATE = 1) then
    if (p@SCX_CPU1_DS_AppEnaState = "Enabled") then
      ...
      write "<!> Failed (9003;9008) - DS Application State is NOT enabled as expected. State = '",p@SCX_CPU1_DS_AppEnaState,"'"
    ...
    if (p@SCX_CPU1_DS_AppEnaState = "Disabled") then
     write "<*> Passed (9003;9008) - DS Application State is disabled as expected."
      ...
      write "<!> Failed (9003;9008) - DS Application State is NOT disabled as expected. State = '",p@SCX_CPU1_DS_AppEnaState,"'"
      ut_setrequirements DS_9003, "F"
      ut_setrequirements DS_9008, "F"
    endif
  endif
