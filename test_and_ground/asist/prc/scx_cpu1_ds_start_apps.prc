proc scx_cpu1_ds_start_apps (step_num)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; Purpose:
...
for file_index = 1 to CFE_ES_MAX_APPLICATIONS do
  if (SCX_CPU1_ES_ALE[file_index].ES_AL_AppName = DSAppName) then
    found_app1 = TRUE
  elseif (SCX_CPU1_ES_ALE[file_index].ES_AL_AppName = "TST_DS") then
    found_app2 = TRUE
  endif
enddo
...
if (found_app1 = FALSE) then
  ...
  ut_setupevents "SCX", "CPU1", {DSAppName}, DS_INIT_EID, "INFO", 2
...
if (found_app2 = FALSE) then
  ...
  write ";*********************************************************************"
  ut_setupevents "SCX", "CPU1", "CFE_ES", CFE_ES_START_INF_EID, "INFO", 1
  ut_setupevents "SCX", "CPU1", "TST_DS", TST_DS_INIT_INF_EID, "INFO", 2
