PROC scx_cpu1_ds_badfiltertbls
;*******************************************************************************
...
SCX_CPU1_DS_PF_TBL_Description  = "Reset No Critical Data Store (CDS) Test"

;; Entry 1
SCX_CPU1_DS_PF_TBL[0].MessageID = x'1000'
;; File #1 - Invalid Index
SCX_CPU1_DS_PF_TBL[0].FilterParams[0].Index = DS_DEST_FILE_CNT
...
SCX_CPU1_DS_PF_TBL[1].MessageID = x'1001'
;; File #1 - Invalid FilterType
SCX_CPU1_DS_PF_TBL[1].FilterParams[0].Index = 1
SCX_CPU1_DS_PF_TBL[1].FilterParams[0].FilterType = DS_BY_TIME + 1
...
SCX_CPU1_DS_PF_TBL[2].MessageID = x'1002'
;; File #1 - Invalid N value
SCX_CPU1_DS_PF_TBL[2].FilterParams[0].Index = 2
SCX_CPU1_DS_PF_TBL[2].FilterParams[0].FilterType = DS_BY_COUNT
SCX_CPU1_DS_PF_TBL[2].FilterParams[0].N_Value = 2
SCX_CPU1_DS_PF_TBL[2].FilterParams[0].X_Value = 1
...
SCX_CPU1_DS_PF_TBL[3].MessageID = x'1003'
;; File #1 - Invalid O value (O > X)
SCX_CPU1_DS_PF_TBL[3].FilterParams[0].Index = 4
SCX_CPU1_DS_PF_TBL[3].FilterParams[0].FilterType = DS_BY_TIME
SCX_CPU1_DS_PF_TBL[3].FilterParams[0].N_Value = 1
SCX_CPU1_DS_PF_TBL[3].FilterParams[0].X_Value = 1
SCX_CPU1_DS_PF_TBL[3].FilterParams[0].O_Value = 2
...
;; Entry 5 -> Valid
SCX_CPU1_DS_PF_TBL[4].MessageID = x'1004'
;; File #1
SCX_CPU1_DS_PF_TBL[4].FilterParams[0].Index = 5
SCX_CPU1_DS_PF_TBL[4].FilterParams[0].FilterType = DS_BY_TIME
...
local endmnemonic = "SCX_CPU1_DS_PF_TBL[" & maxEntry & "].FilterParams["
endmnemonic = endmnemonic & maxFilterParams & "].O_Value"

s create_tbl_file_from_cvt(hostCPU,filterAppid,"Invalid Filter Table Description","ds_badfilter1.tbl",filterTblName,"SCX_CPU1_DS_PF_TBL_Description",endmnemonic)

;; Set the Table description text to a valid string
SCX_CPU1_DS_PF_TBL_Description  = "Reset No CDS Test"

s create_tbl_file_from_cvt(hostCPU,filterAppid,"Invalid Filter Table Entry #1 Index","ds_badfilter2.tbl",filterTblName,"SCX_CPU1_DS_PF_TBL_Description",endmnemonic)

;; Set the Index to a valid file
SCX_CPU1_DS_PF_TBL[0].FilterParams[0].Index = 0

s create_tbl_file_from_cvt(hostCPU,filterAppid,"Invalid Filter Table Entry #2 Type","ds_badfilter3.tbl",filterTblName,"SCX_CPU1_DS_PF_TBL_Description",endmnemonic)

;; Set the Filter Type back to valid
SCX_CPU1_DS_PF_TBL[1].FilterParams[0].FilterType = DS_BY_TIME

s create_tbl_file_from_cvt(hostCPU,filterAppid,"Invalid Filter Table Entry #3 N>X","ds_badfilter4.tbl",filterTblName,"SCX_CPU1_DS_PF_TBL_Description",endmnemonic)

;; Set the N Value to a valid number
SCX_CPU1_DS_PF_TBL[2].FilterParams[0].N_Value = 1

s create_tbl_file_from_cvt(hostCPU,filterAppid,"Invalid Filter Table Entry #4 O>X","ds_badfilter5.tbl",filterTblName,"SCX_CPU1_DS_PF_TBL_Description",endmnemonic)

%liv (log_procedure) = logging

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_ds_badfiltertbls"
write ";*********************************************************************"
ENDPROC
