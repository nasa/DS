    ...
    */
    ...
    for (file_num = 0; file_num < number_of_files; file_num++)
    {
        ...
        */
        ...
        fprintf(outfile, "Content Type: %02X%02X%02X%02X - %s\n", file_header[0], file_header[1], file_header[2],
                file_header[3], &contentType);
        ...
        fprintf(outfile, "Primary Hdr Length: %02X%02X%02X%02X - %d\n", file_header[8], file_header[9], file_header[10],
                file_header[11], fourByte.value);
        ...
        fprintf(outfile, "Spacecraft ID:  %02X%02X%02X%02X - %d\n", file_header[12], file_header[13], file_header[14],
                file_header[15], fourByte.value);
        ...
        fprintf(outfile, "Processor ID:   %02X%02X%02X%02X - %d\n", file_header[16], file_header[17], file_header[18],
                file_header[19], fourByte.value);
        ...
        fprintf(outfile, "Application ID: %02X%02X%02X%02X - %d\n", file_header[20], file_header[21], file_header[22],
                file_header[23], fourByte.value);
        ...
        fprintf(outfile, "Create Time (secs): %02X%02X%02X%02X - %u\n", file_header[24], file_header[25],
                file_header[26], file_header[27], fourByte.value);
        ...
        fprintf(outfile, "Create Time (subs): %02X%02X%02X%02X - %u\n", file_header[28], file_header[29],
                file_header[30], file_header[31], fourByte.value);
        ...
        fprintf(outfile, "Close Time (secs): %02X%02X%02X%02X - %u\n", file_header[64], file_header[65],
                file_header[66], file_header[67], fourByte.value);
        ...
        fprintf(outfile, "Close Time (subs): %02X%02X%02X%02X - %u\n", file_header[68], file_header[69],
                file_header[70], file_header[71], fourByte.value);
        ...
        if ((headers_only_flag[0] != 'y') && (headers_only_flag[0] != 'Y'))
        {
            ...
            for (i = 0; i < print_rows; i++)
            {
                fprintf(outfile, "%02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X\n",
                        packet_data[i * PRINT_COLUMNS], packet_data[i * PRINT_COLUMNS + 1],
                        packet_data[i * PRINT_COLUMNS + 2], packet_data[i * PRINT_COLUMNS + 3],
                        packet_data[i * PRINT_COLUMNS + 4], packet_data[i * PRINT_COLUMNS + 5],
                        packet_data[i * PRINT_COLUMNS + 6], packet_data[i * PRINT_COLUMNS + 7],
                        packet_data[i * PRINT_COLUMNS + 8], packet_data[i * PRINT_COLUMNS + 9],
                        packet_data[i * PRINT_COLUMNS + 10], packet_data[i * PRINT_COLUMNS + 11],
                        packet_data[i * PRINT_COLUMNS + 12], packet_data[i * PRINT_COLUMNS + 13],
                        packet_data[i * PRINT_COLUMNS + 14], packet_data[i * PRINT_COLUMNS + 15]);
            }
